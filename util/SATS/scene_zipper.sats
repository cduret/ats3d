...
dataviewtype scene_zipper_gl_vt =
  ...
  | NodeTransformGL of (GLint, matrix4_t(GLfloat), scene_zipper_gl_vt) // (uniform_idx, matrix, path)
  | NodeScaleGL of (GLint, vector3_t(GLfloat), scene_zipper_gl_vt) // (scale, path)
  | NodeRotateGL of (GLint, vector3_t(GLfloat), scene_zipper_gl_vt) // (rotate, path)
  | NodeTranslateGL of (GLint, vector3_t(GLfloat), scene_zipper_gl_vt) // (translate, path)
